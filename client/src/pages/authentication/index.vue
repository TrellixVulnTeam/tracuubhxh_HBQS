      ...
      <div class="container">
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"
              ...
              <div class="single-item">
                <div>
                  <div>
                    <h3>Hệ thống tra cứu BHXH</h3>
                    <swiper class="swiper" :options="swiperOption">
                      <swiper-slide
                        ><p>
                          Tra cứu thông tin C12
                        </p>
                      </swiper-slide>
                      <swiper-slide>
                        <p>
            ...
            <div class="card tab2-card">
              <div class="card-body">
                <b-tabs content-class="mt-3">
                  <b-tab title="Đơn vị" data-feather="user" active>
                    <login></login>
                  </b-tab>
                  <!-- registration form start -->
                  <b-tab data-feather="lock" title="Bảo hiểm xã hội">
